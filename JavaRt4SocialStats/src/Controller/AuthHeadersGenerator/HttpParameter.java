...
public class HttpParameter implements Comparable<HttpParameter>, java.io.Serializable {
	 ...
	 * @see <a href="http://tools.ietf.org/html/rfc3986#section-2.1">RFC
	 *      3986 - Uniform Resource Identifier (URI): Generic Syntax - 2.1.
	 *      Percent-Encoding</a>
	 */
	...
	/**
	 * @param value
	 *            string to be decoded. The natural opposite of encode()
	 *            above.
	 * @return encoded string
	 * @see <a href="http://wiki.oauth.net/TestCases">OAuth / TestCases</a>
	 * @see <a href=
	 ...
	 *            a query parameter string, like a=hello&amp;b=world
