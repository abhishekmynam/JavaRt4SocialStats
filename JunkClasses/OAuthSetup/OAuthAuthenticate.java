...
public class OAuthAuthenticate implements java.io.Serializable, IOAuth {
	...
	private static final HttpParameter OAUTH_SIGNATURE_METHOD = new HttpParameter("oauth_signature_method",
			"HMAC-SHA1");
	// private static final Logger logger =
	// Logger.getLogger(OAuthAuthorization.class);
	 ...
	 */
	/*
	 * public OAuthAuthenticate(Configuration conf) { this.conf = conf; http =
	 * HttpClientFactory.getInstance(conf.getHttpClientConfiguration());
	 * setOAuthConsumer(conf.getOAuthConsumerKey(),
	 * conf.getOAuthConsumerSecret()); if (conf.getOAuthAccessToken() != null &&
	 * conf.getOAuthAccessTokenSecret() != null) { setOAuthAccessToken(new
	...
	/*
	 * @Override public String getAuthorizationHeader(HttpRequest req) { return
	 * generateAuthorizationHeader(req.getMethod().name(), req.getURL(),
	 * req.getParameters(), oauthToken); }
	 */
	...
	@Override
	public RequestToken getOAuthRequestToken(String callbackURL) throws Exception {
		return getOAuthRequestToken(callbackURL, null, null);
	}

	@Override
	public RequestToken getOAuthRequestToken(String callbackURL, String xAuthAccessType) throws Exception {
		return getOAuthRequestToken(callbackURL, xAuthAccessType, null);
	}

	/*
	 * @Override public RequestToken getOAuthRequestToken(String callbackURL,
	 * String xAuthAccessType, String xAuthMode) throws Exception { if
	 * (oauthToken instanceof AccessToken) { throw new
	 * IllegalStateException("Access token already available."); }
	 * List<HttpParameter> params = new ArrayList<HttpParameter>(); if
	 * (callbackURL != null) { params.add(new HttpParameter("oauth_callback",
	 * callbackURL)); } if (xAuthAccessType != null) { params.add(new
	 * HttpParameter("x_auth_access_type", xAuthAccessType)); } if (xAuthMode !=
	 * null) { params.add(new HttpParameter("x_auth_mode", xAuthMode)); }
	 * oauthToken = new RequestToken( http.post(conf.getOAuthRequestTokenURL(),
	 * params.toArray(new HttpParameter[params.size()]), this, null), this);
	 * return (RequestToken) oauthToken; }
	 */

	/*
	 * @Override public AccessToken getOAuthAccessToken() throws Exception {
	 * ensureTokenIsAvailable(); if (oauthToken instanceof AccessToken) { return
	 * (AccessToken) oauthToken; } oauthToken = new
	 * AccessToken(http.post(conf.getOAuthAccessTokenURL(), null, this, null));
	 * return (AccessToken) oauthToken; }
	 */

	/*
	 * @Override public AccessToken getOAuthAccessToken(String oauthVerifier)
	 * throws Exception { ensureTokenIsAvailable(); oauthToken = new
	 * AccessToken(http.post(conf.getOAuthAccessTokenURL(), new HttpParameter[]
	 * { new HttpParameter("oauth_verifier", oauthVerifier) }, this, null));
	 * return (AccessToken) oauthToken; }
	 */

	@Override
	public AccessToken getOAuthAccessToken(RequestToken requestToken) throws Exception {
		this.oauthToken = requestToken;
		return getOAuthAccessToken();
	}

	@Override
	public AccessToken getOAuthAccessToken(RequestToken requestToken, String oauthVerifier) throws Exception {
		this.oauthToken = requestToken;
		return getOAuthAccessToken(oauthVerifier);
	}

	/*
	 * @Override public AccessToken getOAuthAccessToken(String screenName,
	 * String password) throws Exception { try { String url =
	 * conf.getOAuthAccessTokenURL(); if (0 == url.indexOf("http://")) { // SSL
	 * is required // @see https://dev.twitter.com/docs/oauth/xauth url =
	 * "https://" + url.substring(7); } oauthToken = new
	 * AccessToken(http.post(url, new HttpParameter[] { new
	 * HttpParameter("x_auth_username", screenName), new
	 * HttpParameter("x_auth_password", password), new
	 * HttpParameter("x_auth_mode", "client_auth") }, this, null)); return
	 * (AccessToken) oauthToken; } catch (Exception te) { throw new
	 * Exception("The screen name / password combination seems to be invalid.");
	 * } }
	 */

	/*
	 * @Override public void setOAuthAccessToken(AccessToken accessToken) {
	...
	public String generateAuthorizationHeader(String method, String url, HttpParameter[] params) {
		...
		String auth_Token = keys.AuthToken;
		...
		oauthHeaderParams.add(new HttpParameter("oauth_token", auth_Token));
	 ...
	 */
	/*
	 * package String generateAuthorizationHeader(String method, String url,
	 * HttpParameter[] params, OAuthToken token) {
	 * 
	 * return generateAuthorizationHeader(method, url, params,token); }
	 */
	...
	/* package */ String generateSignature(String data, OAuthToken token) {
		...
		try {
			...
			String oauthSignature = HttpParameter.encode(consumerSecret) + "&" +HttpParameter.encode("T5UIgLgDPZms7oqZnxMwm6M3S54AEngu0yVAfgcZPvaVG");
	 ...
	 * @see <a href=
	 *      "http://groups.google.com/group/oauth/browse_thread/thread/a8398d0521f4ae3d/9d79b698ab217df2?hl=en&lnk=gst&q=space+encoding#9d79b698ab217df2">Space
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof IOAuth))
			return false;

		OAuthAuthenticate that = (OAuthAuthenticate) o;
	...
	@Override
	public AccessToken getOAuthAccessToken(String oauthVerifier) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public AccessToken getOAuthAccessToken(String screenName, String password) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
