...
public class oAuthBase {
	...
	protected static String normalizeRequestParameters(HttpParameter[] params) {
        return normalizeRequestParameters(toParamList(params));
    }

    protected static String normalizeRequestParameters(List<HttpParameter> params) {
    ...
    protected static List<HttpParameter> toParamList(HttpParameter[] params) {
